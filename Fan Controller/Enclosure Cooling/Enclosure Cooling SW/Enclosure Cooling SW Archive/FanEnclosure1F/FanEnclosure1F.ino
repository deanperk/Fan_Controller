/*
Fan Controller Code Enclosure Version 0.1F
Designed to run on an Trinket Pro processor board
Schematic rev 6
THIS IS A TEST TO VERIFY OPERATION OF 12/24 Low Volt Flash
AND NEW POST ROUTINE
This is the code that the Prod 1.0 rev was created from
 ...
 *----------------------------------------------------------- */                  
 ...
 const int heatLED = 8; //red heatLED
...
delay(500);
digitalWrite(coolLED, LOW);
digitalWrite(twentyfourLED, HIGH);
delay(500);
digitalWrite(twentyfourLED, LOW);
digitalWrite(twelveLED, HIGH);
delay(500);
digitalWrite(twelveLED, LOW);

/*
Fan Controller Code Enclosure Version Prod 1.1
Designed to run on an Trinket Pro processor board
Schematic rev 6

Rev History
1.0 Prod Release
1.1 modified POST toflash cool LED to signify fan enclosure F/W loaded
...
// POST Flash Cool LED to notify user of "fan enclosure" mode

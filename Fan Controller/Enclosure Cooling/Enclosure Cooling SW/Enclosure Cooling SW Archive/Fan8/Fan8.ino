/*
Fan Controller Code Version 0.8
...
ISR(TIMER1_COMPA_vect)        //timer compare interrupt service routine
{
 ...
 if (x == 0){
  timeCounter = 0;
  measureVoltage();           //does this need volatile variable?
  measureBattTemp();          //does this need volatile variable?
  measureAmbTemp();           //does this need volatile variable?
 }
} //end of timer isr
...
attachInterrupt (1,fanOverideFall,FALLING);  // attach Override Falling ISR
attachInterrupt (1,fanOverideRise,RISING);  // attach Override Rising ISR
